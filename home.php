...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         <h3 class="title">Por favor, inicie sesión o regístrese</h3>
...
<div class="flex">
   <a href="buscar_curso.php?"><i class="fas fa-code"></i><span>desarrollo</span></a>
...
<section class="courses">
   <h1 class="heading">Mis cursos</h1>
   <div class="box-container">
   <?php
...
?>
      ...
      <?php
         ...
         echo '<p class="empty">¡Aún no se han agregado cursos!</p>';
      }
      ?>
   </div>
   <div class="more-btn">
