...
<section class="playlist">
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Guardar curso</span></button>
            <?php
               }
            ?>
         </form>
   ...
   <p><?= $fetch_playlist['description']; ?></p>
      ...
      <?php
            ...
            echo '<p class="empty">El curso no fue encontrado!</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <h1 class="heading">Tus cursos</h1>
...
?>
      ...
      <?php
            ...
            echo '<p class="empty">Aun no se han añadido cursos!</p>';
         }
      ?>
