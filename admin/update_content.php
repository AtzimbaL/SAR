...
<section class="video-form">
   ...
   <h1 class="heading">Actualizar curso</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--Seleciona una categoria</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Aún no se ha creado ningun curso</option>';
         }
         ?>
      </select>
      ...
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Ver curso</a>
         <input type="submit" value="Eliminar curso" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">No se encontro el contenido! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
