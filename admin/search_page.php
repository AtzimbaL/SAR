   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Eliminar" class="delete-btn" onclick="return confirm('Borrar video?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Ver curso</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">No se encuentra contenido!</p>';
      }
   }else{
...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Ver categoria</a>
      </div>
      <?php
         } 
      }else{
