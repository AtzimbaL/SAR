...
<section class="video-form">
   ...
   <h1 class="heading">Crear un nuevo curso</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="Nombre" class="box">
      <p>Precio <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Precio" maxlength="1000" cols="30" rows="10"></textarea>
      ...
      <p>Imagen de fondo <span>*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box">
      <p>Video <span>*</span></p>
      <input type="file" name="video" accept="video/*" required class="box">
      <input type="submit" value="Aceptar" name="submit" class="btn">
   </form>
