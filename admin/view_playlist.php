...
<section class="playlist-details">
   ...
   <h1 class="heading">Detalles de la categoria</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Actualizar categoria</a>
            <input type="submit" value="Eliminar" class="delete-btn" onclick="return confirm('Eliminar categoria?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">No se encontro ninguna categoria!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <?php
         ...
         echo '<p class="empty">Esta categoria aun no tiene cursos! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Añadir cursos</a></p>';
      }
   ?>
