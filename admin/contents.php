...
<section class="contents">
   ...
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Nuevo curso</h3>
      <a href="add_content.php" class="btn">Crear curso</a>
   </div>
   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Nueva leccion</h3>
      <a href="add_leccion.php" class="btn">Crear leccion</a>
   </div>
   <?php
...
?>
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <input type="submit" value="Borrar" class="delete-btn" onclick="return confirm('¿Estas seguro de borrar este curso?');" name="delete_video">
      </form>
      <a href="lecciones.php?content_id=<?= $video_id; ?>" class="btn btn-green">Ver lecciones</a>
...
<?php
   ...
   echo '<p class="empty">No se encuentran cursos!</p>';
}
?>
