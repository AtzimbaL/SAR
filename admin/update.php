...
if(isset($_POST['submit'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         $message[] = 'Tamaño de imagen demasiado grande!';
      }else{
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="old_pass" placeholder="Contraseña anterio" maxlength="20"  class="box">
            <p>Nueva contraseña :</p>
            <input type="password" name="new_pass" placeholder="Nueva contraseña" maxlength="20"  class="box">
            <p>Confirmar contraseña :</p>
            <input type="password" name="cpass" placeholder="Confirmar contraseña " maxlength="20"  class="box">
         </div>
      </div>
      <p>Foto :</p>
