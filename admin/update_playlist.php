...
<section class="playlist-form">
   ...
   <h1 class="heading">Actualizar categoria</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="Actualizar categoria" name="submit" class="btn">
      <div class="flex-btn">
         <input type="submit" value="Eliminar" class="delete-btn" onclick="return confirm('Eliminar esta categoria?');" name="delete">
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Ver categoria</a>
      </div>
   </form>
   <?php
      } 
   }else{
      echo '<p class="empty">No hay contenido!</p>';
   }
   ?>
