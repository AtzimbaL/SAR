...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <div class="flex">
      ...
      <div class="col">
         ...
         <input type="password" name="old_pass" placeholder="Ingresa tu contraseña antigua" maxlength="50" class="box">
         <p>Contraseña nueva</p>
         <input type="password" name="new_pass" placeholder="Ingresa tu contraseña nueva" maxlength="50" class="box">
         <p>Confirmar contraseña</p>
         <input type="password" name="cpass" placeholder="Confirma tu contraseña nueva" maxlength="50" class="box">
      </div>
   </div>
